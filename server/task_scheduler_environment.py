...
TASK_TEMPLATES = {
    ...
    "medium": [
        ...
        {"name": "Debug failing test",        "priority": "high",   "effort": 2, "deadline": 5},
        {"name": "Code review (2 PRs)",       "priority": "high",   "effort": 2, "deadline": 7},
        {"name": "Update documentation",      "priority": "medium", "effort": 2, "deadline": 8},
        {"name": "Team meeting preparation",  "priority": "medium", "effort": 1, "deadline": 5},
        {"name": "Fix UI bug",                "priority": "high",   "effort": 1, "deadline": 4},
        {"name": "Optimize query",            "priority": "medium", "effort": 2, "deadline": 7},
    ],
    "hard": [
        {"name": "Database migration",         "priority": "high",   "effort": 3, "deadline": 6},
        {"name": "Security vulnerability fix", "priority": "high",   "effort": 3, "deadline": 5},
        {"name": "Production deployment",      "priority": "high",   "effort": 2, "deadline": 4},
        {"name": "Incident response doc",      "priority": "high",   "effort": 2, "deadline": 6},
        {"name": "Performance optimization",   "priority": "medium", "effort": 3, "deadline": 8},
        {"name": "OAuth implementation",       "priority": "high",   "effort": 3, "deadline": 7},
        {"name": "Load testing",               "priority": "medium", "effort": 2, "deadline": 6},
        {"name": "Emergency hotfix",           "priority": "high",   "effort": 1, "deadline": 3},
        {"name": "Compliance audit",           "priority": "high",   "effort": 2, "deadline": 5},
        {"name": "Client presentation",        "priority": "high",   "effort": 2, "deadline": 4},
    ],
}
